...
${OBJECTDIR}/source/Blog.o: source/Blog.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/postgresql -I../../mxchat/XWeb/source -I../../mxsql/PG/MxSql/source -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Blog.o source/Blog.cpp
...
${OBJECTDIR}/source/MxAdminPG.o: source/MxAdminPG.cpp
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/postgresql -I../../mxchat/XWeb/source -I../../mxsql/PG/MxSql/source -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/MxAdminPG.o source/MxAdminPG.cpp
